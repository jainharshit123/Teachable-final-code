  ...
  return (
    ...
    >
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
        ...
        <Link to="/">
          <img
            src="https://cdn.prod.website-files.com/65393b768d06ee4c16d24a0b/65393dc0c6867e03a9baa122_teachable-logo-light.svg"
            alt="Logo"
            width={150}
            loading="lazy"
            className="bg-none object-contain text-white "
          />
        </Link>
        {/* Navigation links */}
